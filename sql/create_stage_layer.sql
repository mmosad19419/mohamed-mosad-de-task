...
CREATE TABLE stage.best_sellings_lists_books (
  id integer,
...
GRANT USAGE ON SCHEMA stage TO admin;
GRANT SELECT ON ALL TABLES IN SCHEMA stage TO admin;